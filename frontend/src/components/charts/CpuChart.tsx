...
export default function CpuChart({ value }: CpuChartProps) {
  ...
  return (
    <div className="bg-base-surface p-5 rounded-xl border border-base-border">
      <h3 className="text-slate-400 font-medium font-body mb-4">CPU Usage History</h3>
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={history}>
            ...
            />
            <Line type="monotone" dataKey="value" stroke="#F59E0B" strokeWidth={2} dot={false} name="CPU %" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
